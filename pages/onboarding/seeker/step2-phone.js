...
export default function Step2Phone() {
  ...
  function goBack() {
    router.push("/onboarding/seeker/step1-full-name");
  }
  ...
  async function next() {
    ...
    setLoading(false);
    router.push("/onboarding/seeker/step3-address");
  }
    ...
    <div className="min-h-screen flex bg-[#eef1f6]">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-16">
        ...
        >
          ...
          >
            <h1 className="text-3xl font-bold text-[#07102a]">Your Phone</h1>
            <p className="mt-2 text-gray-500">
              We'll use this to contact you about bookings and confirmations.
            </p>
            ...
            <div className="mt-6">
              ...
              >
                <input
                  ...
                  placeholder="e.g. +2349123456789 or 09123456789"
            ...
            <p className="mt-3 text-sm text-gray-400">
              We will never share your phone number without your permission.
            </p>
